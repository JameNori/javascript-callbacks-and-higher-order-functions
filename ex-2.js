...
function atLeastFive(array, operation) {
  ...
  if (pass >= 5) {return true} else {return false};
}
...
- checkGradeOver70 เป็น Callback Function เนื่องจากมีการเรียกใช้เป็น argument ในฟังชั่น atLeastFive

2. ใน Exercise นี้ ฟังก์ชันใดเป็น Higher Order Function?
- atLeastFive เป็น High Order Function เนื่องจากมีฟังชั่น checkGradeOver70 บรรจุอยู่ด้านใน
